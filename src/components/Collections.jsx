...
const Collections = (props) => {
  ...
  const trendingUrl = `https://api.themoviedb.org/3/trending/movie/week?api_key=75002009f55d0126dfdc3d258f18b958`;
  const nowPlayingUrl = `https://api.themoviedb.org/3/movie/now_playing?api_key=75002009f55d0126dfdc3d258f18b958&language=en-US&page=1`;
  const topRatedUrl = `https://api.themoviedb.org/3/movie/top_rated?api_key=75002009f55d0126dfdc3d258f18b958&language=en-US&page=1`;
  const upcomingUrl = `https://api.themoviedb.org/3/movie/upcoming?api_key=75002009f55d0126dfdc3d258f18b958&language=en-US&page=1`;
